...
class MusyncSavDecodeGUI(object):
	...
	def CheckJsonUpdate(self):
		try:
			response = requests.get("https://raw.githubusercontent.com/Ginsakura/MUSYNCSave/main/musync_data/songname.ver", timeout=10)
			githubVersion = response.content.decode('utf8')
			with open("./musync_data/SongName.ver",'r',encoding='utf8') as snju:
